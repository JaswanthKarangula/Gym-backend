...
type Querier interface {
	...
	GetPastWorkoutData1(ctx context.Context, userid int64) ([]GetPastWorkoutData1Row, error)
	GetPastWorkoutData30(ctx context.Context, userid int64) ([]GetPastWorkoutData30Row, error)
	GetPastWorkoutData60(ctx context.Context, userid int64) ([]GetPastWorkoutData60Row, error)
	GetPastWorkoutData7(ctx context.Context, userid int64) ([]GetPastWorkoutData7Row, error)
	GetPastWorkoutData90(ctx context.Context, userid int64) ([]GetPastWorkoutData90Row, error)
